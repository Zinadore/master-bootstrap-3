...
<div id="k2Container" class="container itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<!-- ITEM TOOLBAR CODE POSITION -->
	<?php endif; ?>

	<div class="itemBody row">

		<!-- BOOK IMAGE -->
  		<div class="custom-image-block col-sm-5 col-xs-5">
	  		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
				<img itemprop="image" class="book_img img-responsive center_block" src="<?php echo $this->item->image; ?>" alt="<?php if (!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px;" />
	  		<?php endif; ?>
		...
		<!-- BOOK EXTRA INFO -->
		<div class= "book_info col-sm-7 col-xs-7">
			<?php if($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)): ?>
				<?php $hasExtra = true; ?>
				<div class="basic_info">
					<ul class="info_list">
						<!--Checks the extra info of the item one by one to view the ones we need-->
							...
							<?php if ($extraField->value): ?>
								...
								<?php if ($extraField->name == "Συγγραφέας" && ($useful_value[0] !== "http://")): ?>
									<li id="author_info" class="info_item" itemprop="author">
										<span class="info_value">
											<strong>
												Συγγραφέας: <?php echo $useful_value[0]; ?>
											</strong>
										</span>
									</li>
									<br>
								<?php elseif ($extraField->name == "Εικονογράφηση" && ($useful_value[0] !== "http://")): ?>
									<li id="illustrator_info" class="info_item">
										<span class="info_value">
											Εικονογράφηση: <?php echo $useful_value[0]; ?>
										</span>
									</li>

								<?php elseif ($extraField->name == "Άλλο: Περιγραφή"): ?>
									<li id="other_info" class="info_item">
											...
											<?php if ($extraFieldSpecial->value): ?>
												<?php if ($extraFieldSpecial->name == "Άλλο"): ?>
													<?php if (strpos($extraFieldSpecial->value, 'href="http://"') !== false): ?>
														...
														<?php endif; ?>
													<?php else: ?>
														<div id="bookbookOtherSimple">
															<?php
															echo $extraField->value;
															echo ": ";
															?>
														</div>
														<div id="bookbookOtherBold">
								...
								<?php elseif ($extraField->name == "Εκδότης" && ($useful_value[0] !== "http://")): ?>
									<li id="publisher_info" class="info_item" itemprop="publisher">
										<span class="info_value">
											Εκδόσεις: <?php echo $useful_value[0]; ?>
										</span>
									</li>

								<?php elseif ($extraField->name == "Σειρά" && ($useful_value[0] !== "http://")): ?>
									<li id="series_info" class="info_item">
										<span class="info_value">
											Σειρά: <?php echo $useful_value[0]; ?>
										</span>
									</li>

								<?php elseif ($extraField->name == "Ηλικία" && (strcmp($extraField->value, "Χωρίς ηλικία") !== 0)): ?>
									<li id="age_restr_info" class="info_item">
	...
	<!--END OF ITEM BODY ROW-->

	<!-- ITEM RATING ROW -->
	<div class="item_rating flexbox row">
		<div class="container flexbox">
			<?php if($this->item->params->get('itemRating')): ?>
				<!-- Item Rating -->
				<div class="itemRatingBlock col-xs-6">
					<span>
						Βαθμολογίστε το βιβλίο
					</span>
...
?>
	...
	<!--END OF ITEM CONTENT ROW-->
	<div class="social_buttons row">
		<?php if($this->item->params->get('itemTwitterButton',1) || $this->item->params->get('itemFacebookButton',1) || $this->item->params->get('itemGooglePlusOneButton',1)): ?>
			<!-- Social sharing -->
			<div class="itemSocialSharing flexbox container">

				<?php if($this->item->params->get('itemTwitterButton',1)): ?>
				<!-- Twitter Button -->
				<div class="itemTwitterButton col-md-4 col-xs-12">
				...
				<!-- Facebook Button -->
				<div class="itemFacebookButton col-md-4 col-xs-12">
					<div id="fb-root"></div>
				...
				<!-- Google +1 Button -->
				<div class="itemGooglePlusOneButton col-md-4 col-xs-12">
  ...
  <div class="itemNavigation">
  	<span class="itemNavigationTitle">Περισσότερα στην κατηγορία: </span>
  ...
  <?php endif; ?>
	...
	<?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
		...
		<div class="comments_section row">
